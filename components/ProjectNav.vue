<template>
  <div class="d-flex">
    ...
    <project-card :link="prevPageSlug" :title="prevPageName" :category="prevPageCategory"
      :description="prevPageDescription" class="project-card--nav" />
    <project-card :link="nextPageSlug" :title="nextPageName" :category="nextPageCategory"
      :description="nextPageDescription" class="project-card--nav" />
